...
function imc () {
    ...
    if (nome !== '' && altura !== '' && peso !== '') {
        ...
        if (valorIMC < 18.5){
            ...
            classificacao = 'com obesidade grau I, está precisando de uma atividade fisíca e uma dieta';
        }else if (valorIMC < 40){
            classificacao = 'com obesidade grau II, está precisando de uma atividade fisíca e uma dieta';
        }else {
